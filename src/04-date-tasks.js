...
function timeSpanToString(startDate, endDate) {
  ...
  const minutes = Math.floor((timespanMS - hours * 1000 * 60 * 60) / 1000 / 60);
  const seconds = Math.floor((timespanMS - hours * 1000 * 60 * 60 - minutes * 1000 * 60) / 1000);
  const mseconds = Math.floor(timespanMS - hours * 1000 * 60 * 60
  ...
  timespan += `${seconds}.`;
  if (mseconds.toString().length === 1) {
    timespan += '00';
  } else if (mseconds.toString().length === 2) {
    timespan += '0';
  }
  timespan += `${mseconds}`;
  return timespan;
